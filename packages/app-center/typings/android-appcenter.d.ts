	...
	export module microsoft {
		export module appcenter {
			export class AppCenter {
				...
				public static setNetworkRequestsAllowed(param0: boolean): void;
				public static isNetworkRequestsAllowed(): boolean;
				public constructor();
			...
			export module channel {
				export class Channel {
					...
					public constructor(implementation: {
						...
						shutdown(): void;
						setNetworkRequests(param0: boolean): void;
					});
					public constructor();
					...
					public setNetworkRequests(param0: boolean): void;
			...
			export module crashes {
				export module utils {
					export class ErrorLogHelper {
						...
						public static setErrorLogDirectory(param0: java.io.File): void;
						...
						public static getStoredUserInfo(param0: java.io.File): string;
...
declare module com {
	export module microsoft {
		export module appcenter {
			export module ingestion {
				export abstract class AbstractAppCenterIngestion extends com.microsoft.appcenter.ingestion.Ingestion {
					public static class: java.lang.Class<com.microsoft.appcenter.ingestion.AbstractAppCenterIngestion>;
					public setHttpClient(param0: com.microsoft.appcenter.http.HttpClient): void;
					public constructor();
					public close(): void;
					...
					public constructor(param0: com.microsoft.appcenter.http.HttpClient, param1: string);
					public getServiceCall(param0: string, param1: string, param2: java.util.Map<string,string>, param3: com.microsoft.appcenter.http.HttpClient.CallTemplate, param4: com.microsoft.appcenter.http.ServiceCallback): com.microsoft.appcenter.http.ServiceCall;
					public isEnabled(): boolean;
					public reopen(): void;
					public setLogUrl(param0: string): void;
				}
...
declare module com {
	export module microsoft {
		export module appcenter {
			export module ingestion {
				export class AppCenterIngestion extends com.microsoft.appcenter.ingestion.AbstractAppCenterIngestion {
...
declare module com {
	export module microsoft {
		export module appcenter {
			export module ingestion {
				export class OneCollectorIngestion extends com.microsoft.appcenter.ingestion.AbstractAppCenterIngestion {
		...
		export module appcenter {
			export module utils {
				export class PrefStorageConstants {
					...
					public static ALLOWED_NETWORK_REQUEST: string;
					public constructor();
				}
			}
		}
		...
		export module appcenter {
			export module utils {
				export module crypto {
					export class CryptoAesAndEtmHandler extends com.microsoft.appcenter.utils.crypto.CryptoHandler {
						public static class: java.lang.Class<com.microsoft.appcenter.utils.crypto.CryptoAesAndEtmHandler>;
						public constructor();
